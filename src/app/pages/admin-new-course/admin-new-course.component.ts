...
import { CourseApiService } from 'src/app/services/courseapi.service';
...
export class AdminNewCourseComponent {
  ...
  instructornames : string[] = ["John", "Sarah", "Michael", "Josh","Sam","Robin","Clark","Steve"];


  constructor(private course: CourseService, private alert: AlertService,private api: CourseApiService) { }
  ...
  onSubmit(ngForm: NgForm) {
    ...
    this.api.post('/apicourse/course/add', credentials).subscribe((res: any) => {
